...
![图3-6 “Add user”表单](../images/pic-3-6.png)
...
- 选上“Notify user of new account”选框（单击此选项使得Drupal能够发送一封邮件给用户，通知他们自己的新帐户）。
- 你可以选择上传用户照片(头像),使这个人的个人联系表单通过勾选“Personal contact form”，并依个人所在位置设置时区的值。出于演示目的，我们将保留这些字段默认值。
- 点击“Create new account”按钮保存帐户。
...
Drupal的特性之一，节省站点管理员一年的工时，能为用户重置密码，免去用户电邮管理员要求重置密码。如果你登出你的站点了（点击页面右上角的退出链接），你会注意到，右边栏“Log in”按钮下面，有重设密码的链接（参见图3-8）。
