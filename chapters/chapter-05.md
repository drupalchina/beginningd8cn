...
当你问Drupal开发者，Drupal最强大的特性是什么? 许多人将会说是它可以自定义内容类型的能力。 那什么是内容类型呢？你可以把内容类型看做一个模板，通过这个模板用户可以在你的网站上编辑内容。你可以选择Drupal 内核中已经有的内容类型比如"Basic page" 或者 "Article" 来满足你网站的所有需要 。但是，很多时候你需要是使用自定义内容类型来更多的控制用户如何输入信息，或是输入的信息以何种方式显示在网站上。 这一个章节，将会从零开始向你展示自定义一个内容类型是多么的简单 ！请找一个舒适的环境，拿好你的票，开始我们新的旅程吧 !
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/content_type.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/add_content_type.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/add_content_type_detail.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/publish_options.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/display_settings.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/menu_setting.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/manage_field.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/changing_label.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/revised_field.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/add_field.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/setting_date.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/setting_date2.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/manage_field2.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/event_List.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/new_event.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/content_view.png)
...
![radio\_buttons](http://work.beiweng.org/d/file/drupal/chapter5/2016-04-08/03effcb355bd3630bf41f53d5da21197.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/select_list.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/file_upload.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/file_configure_more.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/text_area.png)

图5-30 用于驾驶路线的新文本区域

### 5.5.5 数值字段和其他字段类型

通过遍历前面列出的各种字段类型，你可以看到，我们创建的几乎每个字段类型都有一个模式和一组常用参数。数值字段本质上是一个文本字段，但是由Drupal自动限制，以便它只接受数字字符（0-9）。当你通过下载和启用贡献的字段模块来扩展字段类型时，你会发现与你正在创建的字段的结构过在创建过程上有轻微的变化。但是，整个过程将是相同的。如果您还没有这样做，现在是浏览可用于扩展Drupal 8内核中可用的字段模块列表用以扩展Drupal功能的完美时间。访问  [http://drupal.org/project/modules](http://drupal.org/project/modules) ，点击“模块类别”过滤器中的字段项，然后点击搜索。当你浏览时，确保浏览的是为Drupal 8构建的字段模块，因为字段中许多固有的功能现在是Drupal核心的一部分，而在以前的Drupal版本中，您必须下载并安装CCK，才能完成我们刚刚使用Drupal完成的。要将列表缩小到只有Drupal 8，请从Core compatibility下拉列表中选择8.x，然后单击Search按钮。
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/manage_display.png)
...
![](http://llwoll.github.io/2016/04/20/Drupal-内容类型/manage_display2.png)
